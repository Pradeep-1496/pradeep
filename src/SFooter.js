      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                ...
                >
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.03 20 4 16.97 4 12C4 7.03 7.03 4 12 4C16.97 4 20 7.03 20 12C20 16.97 16.97 20 12 20ZM12 6C12.55 6 13 6.45 13 7V11C13 11.55 12.55 12 12 12C11.45 12 11 11.55 11 11V7C11 6.45 11.45 6 12 6ZM12 14C12.55 14 13 14.45 13 15V17C13 17.55 12.55 18 12 18C11.45 18 11 17.55 11 17V15C11 14.45 11.45 14 12 14Z"
                    ></path>
                  </svg>
                </a>
              </li>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            >
              <a href="https://drive.google.com/uc?export=download&id=1mVwWAyUSu23pKap45NFwgbzBmTn3jry0">
                Download CV
              </a>
            </button>
          </div>
